...
complete -c lsd -l permission -d 'How to display permissions [default: rwx]' -r -f -a "{rwx	,octal	}"
complete -c lsd -l size -d 'How to display size [default: default]' -r -f -a "{default	,short	,bytes	}"
complete -c lsd -l date -d 'How to display date [default: date] [possible values: date, relative, +date-time-format]' -r
